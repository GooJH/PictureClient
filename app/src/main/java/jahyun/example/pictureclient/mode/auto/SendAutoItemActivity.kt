...
class SendAutoItemActivity : AppCompatActivity() {
    ...
    private fun getImageInfo() {
        ...
        // 사진 파일 불러오기
        val imageCursor = contentResolver.query(images, imagesProjection, null, null, MediaStore.Images.Media.DATE_TAKEN + " desc")
    ...
    private fun getVideoInfo() {
        ...
        // 동영상 파일 불러오기
        val videoCursor = contentResolver.query(videos, videosProjection, null, null, MediaStore.Video.Media.DATE_TAKEN + " desc")
